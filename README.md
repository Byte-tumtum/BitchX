...
./configure --prefix=$HOME --with-plugins --prefix=$HOME: Use this if you are not root to install BitchX to your home directory.--with-plugins: Recommended if you plan on using the various plugins distributed with BitchX.--with-tcl: Optional; add this only if you require Tcl script support.
